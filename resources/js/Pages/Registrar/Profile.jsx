              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-gray-900 font-medium">{registrar?.FirstName || 'Not provided'}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 font-medium">{registrar?.MiddleName || 'Not provided'}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 font-medium">{registrar?.LastName || 'Not provided'}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 font-medium">{registrar?.email || 'Not provided'}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 font-medium">Registrar</p>
                  </div>
