      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Grades Management</h3>
            <p className="text-gray-600">This feature is coming soon. You'll be able to enter and manage student grades here.</p>
          </div>
        </main>
      </div>
    </div>
