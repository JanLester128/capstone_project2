...
export default function Enrollments({ 
  ...
  const handleApprovalSubmit = () => {
    ...
    router.put(
      `/registrar/enrollments/${selectedEnrollment.id}/status`,
      {
        status: 'enrolled',
  ...
  const handleStatusUpdate = (enrollmentId, status) => {
    ...
    router.put(`/registrar/enrollments/${enrollmentId}/status`, { status }, {
                          ...
                          >
                            ...
                            <td className="px-4 py-3">
                              <div className="flex items-center justify-end gap-2">
                                ...
                                {enrollment.status === 'enrolled' ? (
                                  <Link
                                    href={`/registrar/students/${enrollment.student_personal_info_id || enrollment.student?.id}/enrollments`}
